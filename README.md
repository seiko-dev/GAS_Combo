...
Git LFSを利用しているため、**Githubの"Dowmload ZIP"機能でダウンロードした場合は正しく動作しない**ようです。Cloneせず利用する場合、[Release](https://github.com/seiko-dev/GAS_Combo/releases)から最新のものを取得して頂ければと思います。
